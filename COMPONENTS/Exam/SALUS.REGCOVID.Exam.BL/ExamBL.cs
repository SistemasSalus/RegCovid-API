...
namespace SALUS.REGCOVID.Exam.BL
{
    public class ExamBL
    {
        ...
        public bool SaveSurvey(SurveyRequest oSurveyRequest)
        {
            ...
            var campoReferencia = valuesDB.Find(p => p.ComponentFieldId == Constants.PR_DOMICILIO_ID || p.ComponentFieldId == Constants.ANTIGENO_DOMICILIO_ID);
        ...
        public bool SaveLaboratory(LaboratoryRequest oLaboratoryRequest)
        {
            ...
            var campoReferencia = valuesDB.Find(p => p.ComponentFieldId == Constants.PR_RES_1_PRUEBA_ID || p.ComponentFieldId == Constants.ANTIGENO_RES_1_PRUEBA_ID);
